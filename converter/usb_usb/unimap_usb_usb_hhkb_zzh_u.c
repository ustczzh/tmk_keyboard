...
//2, for Logitech and ThinkPad, L2
    ...
    GRV, F1,  F2,  F3,  F4,  F5,  F6,  F7,  F8,  F9,  F10, F11, F12, INS, DEL,      TRNS,DL0, BACK,    TRNS,TRNS,TRNS,TRNS,
    CAPS,M_1 ,TRNS,TRNS,TRNS,TRNS,TRNS,PGUP,UP,  PGDN,TRNS,DL1, DL0,      BSPC,     TRNS,DL1, FRWD,    TRNS,TRNS,TRNS,TRNS,

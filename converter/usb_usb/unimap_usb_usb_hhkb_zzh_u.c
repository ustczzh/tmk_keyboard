...
//2, for Logitech and ThinkPad, L2
    ...
    GRV, F1,  F2,  F3,  F4,  F5,  F6,  F7,  F8,  F9,  F10, F11, F12, INS, DEL,      DL1, TRNS,BACK,    TRNS,TRNS,TRNS,TRNS,
    CAPS,M_1 ,TRNS,TRNS,TRNS,TRNS,TRNS,PGUP,UP,  PGDN,TRNS,TRNS,TRNS,     BSPC,     DL0, TRNS,FRWD,    TRNS,TRNS,TRNS,TRNS,

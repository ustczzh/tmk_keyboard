...
#endif
//0, for HHKB BT & ThinkPad, QWERTY, Game
    UNIMAP(
...
//5, HHKB, L3
    UNIMAP(
              TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,
    TRNS,     TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,          TRNS,TRNS,TRNS,         TRNS,TRNS,TRNS,
    TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,7,   8,   9,   0,   PMNS,PPLS,TRNS,TRNS,     TRNS,TRNS,TRNS,    TRNS,TRNS,TRNS,TRNS,
    TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,4,   5,   6,   PAST,TRNS,TRNS,     TRNS,     TRNS,TRNS,TRNS,    TRNS,TRNS,TRNS,TRNS,
...
//6, HHKB, L2
    ...
    GRV, F1,  F2,  F3,  F4,  F5,  F6,  F7,  F8,  F9,  F10, F11, F12, TRNS,TRNS,     TRNS,TRNS,BACK,    TRNS,TRNS,TRNS,TRNS,
    WMAX,WH_L,WH_U,MS_U,WH_D,WH_R,DEL, PGUP,UP,  PGDN,TRNS,TRNS,TRNS,     BSPC,     TRNS,TRNS,FRWD,    TRNS,TRNS,TRNS,TRNS,
    TRNS,LTAB,MS_L,MS_D,MS_R,RTAB,HOME,LEFT,DOWN,RGHT,END, BSPC,     TRNS,ENT,                         TRNS,TRNS,TRNS,TRNS,
    WMIN,TRNS,BACK,FRWD,BTN1,BTN2,BTN3,BSPC,ENT, TRNS,TRNS,TRNS,     TRNS,TRNS,          PGUP,         TRNS,TRNS,TRNS,TRNS,
